...
public interface I {
	...
	int PAGE_ID_DEFAULT = 0;                        //分页的默认下载页数
	int PAGE_SIZE_DEFAULT = 20;                    //分页的默认每页数量
	...
	//下载用户头像
	String REQUSET_DOWNLOAD_AVATAR_USER
			= SuperWeChatApplication.SEVER_ROOT
			+ "?" + KEY_REQUEST + "=" + REQUEST_DOWNLOAD_AVATAR + "&" + AVATAR_TYPE + "";
	//下载群头像
	String REQUSET_DOWNLOAD_AVATAR_GROUP
			= SuperWeChatApplication.SEVER_ROOT
